                ...
                <div class="card-content" >
                    <div class="card-body">
                        <ul class="nav nav-tabs mb-3" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center {{ $tab == 'account-tab' ? 'active' : '' }}" wire:click="$set('tab', 'account-tab')" id="account-tab" data-toggle="tab" href="#account" aria-controls="account" role="tab" aria-selected="true">
                                    <i class="feather icon-settings mr-25"></i><span class="d-none d-sm-block">@lang('setting.setting_information')</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center {{ $tab == 'social-tab' ? 'active' : '' }}" wire:click="$set('tab', 'social-tab')" id="social-tab" data-toggle="tab" href="#social" aria-controls="social" role="tab" aria-selected="true">
                                    <i class="feather icon-settings mr-25"></i><span class="d-none d-sm-block">@lang('setting.setting_social_information')</span>
                                </a>
                            </li>
                        </ul>
                        <div class="tab-content"  >
                            <div class="tab-pane {{ $tab == 'account-tab' ? 'active' : '' }}" id="account" aria-labelledby="account-tab" role="tabpanel">
                                ...
                                <form id="profile_update" >
                                    <div class="row">
                                        ...
                                        <div class="col-12 d-flex flex-sm-row flex-column justify-content-end mt-1">
                                            @if(in_array('setting_edit',$this->actions_permission()) )
                            ...
                            <div class="tab-pane {{ $tab == 'social-tab' ? 'active' : '' }}"  id="social" aria-labelledby="social-tab" role="tabpanel">
