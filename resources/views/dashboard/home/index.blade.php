<div>
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">@lang('home.model_name')</h2>
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('dashboard')}}" >@lang('lang.Dashboard')</a>
                            </li>
                            <li class="breadcrumb-item active">@lang('home.model_name')</li>
                        </ol>
                    </div>
                </div>
            </div>
    ...
    <div class="content-body">
        <section id="data-thumb-view" class="data-thumb-view-header">
            <x-search :fields="$searchable" title="{{__('home.model_search_name')}}" search_button="{{__('home.model_search_button')}}" search_button_rest="{{__('home.model_search_button_rest')}}" />
            <div class="table-responsive">
                <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                    <div class="top">
                        <div class="actions action-btns">

                            @if(in_array('home_create',$this->actions_permission()) )
                            <div class="dt-buttons btn-group">
                                <a href="{{route('dashboard.home.create')}}"  class="btn btn-outline-primary mr-1 mb-1 waves-effect waves-light"><i class="feather icon-plus-circle"></i>
                                    @lang('home.model_search_button_add')
                                </a>
                            </div>
                        ...
                        @forelse($data  as $i=>$value)
                            <tr role="row" class="{{$i%2?'odd':'even'}}" >
                                ...
                                <td class="product-img ">
 	 	 	 	 	 		 			 	...
 	 	 	 	 	 		 			 	{{$value->salesAgent?$value->salesAgent->name:''}}
 	 	 	 	 	 		 			 	</td>

                                <td class="product-action">

                                    @if(in_array('home_edit',$this->actions_permission()) )
                                    ...
                                    @endif
                                    @if(in_array('home_delete',$this->actions_permission()) )
