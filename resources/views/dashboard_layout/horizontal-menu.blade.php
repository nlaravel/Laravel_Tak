    ...
    <div class="navbar-wrapper">
        <div class="navbar-container content">
            <div class="navbar-collapse" id="navbar-mobile">
                ...
                <a class="dropdown-item" href="{{route('lang.switchLang',$lang)}}" data-language="ar">@if ( $lang== 'ar')<i class="flag-icon flag-icon-ps"></i>@else <i class="flag-icon flag-icon-us"></i> @endif{{$language}}</a>
                @endif
                @endforeach
                </div>
                </li>
